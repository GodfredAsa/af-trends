...
export function IconBoxes(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true" {...props}>
      ...
      <path d="M12 12V4M12 12l8-4M12 12L4 8" />
    </svg>
  )
}
...
export function IconShirt(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true" {...props}>
      <path d="M8 6l4 3 4-3 3 2-2 3v9H7V11L5 8z" />
    </svg>
  )
}
...
export function IconUsers(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true" {...props}>
      ...
      <path d="M16 14.5c2.2.2 4 1.6 4.6 4.5" />
    </svg>
  )
}
...
export function IconFingerprint(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true" {...props}>
      <path d="M12 4.5a7 7 0 0 1 7 7V18" />
      <path d="M12 7a4.5 4.5 0 0 1 4.5 4.5V19" />
      <path d="M12 9.5A2 2 0 0 0 10 11.5V20" />
      <path d="M7.2 8.2A7 7 0 0 0 5 12.5V17" />
      <path d="M8.8 12.2v5.2" />
    </svg>
  )
}
